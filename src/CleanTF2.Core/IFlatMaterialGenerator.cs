namespace CleanTF2.Core
{
    public interface IFlatMaterialGenerator
    {
        ...
        /// <param name="resize">If true, resizes materials to 1024x1024. If false, leaves materials at 1x1.</param>
        Task Generate(string package, IEnumerable<string> materials, string outputDirectory, bool resize, Action<string> setCurrentStatus);
    }
}
