...
namespace CleanTF2.CLI.Commands
{
    internal sealed class FlattenCommand : AsyncCommand<FlattenCommand.Settings>
    {
        ...
        public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
        {
            ...
            // Flatten textures
            await GenerateFlatTF2Textures(settings.TF2Directory, tf2MaterialsSaveDirectory);
            await GenerateFlatHL2Textures(settings.TF2Directory, hl2MaterialsSaveDirectory);
